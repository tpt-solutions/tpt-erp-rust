...
//! - [`StateMachine`] — derive macro (re-exported from `tpt-macros`) that generates
...
/// `tpt-primitives` to get domain primitives and the state-machine derive.
pub use tpt_macros::StateMachine;
